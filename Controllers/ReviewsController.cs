...
namespace kwiqstage.Controllers
{
    ...
    public class ReviewsController : ControllerBase
    {
        ...
        public ReviewsController(kwiq_prodContext context)
        {
            _context = context;
        }
        ...
        public ActionResult<List<Reviews>> GetItemReviews (int item_id) 
        {
            ...
            List<Reviews> ItemReviews = new List<Reviews> ();

            foreach (var entry in list) 
            {
                if (entry.ItemId == item_id)
                {
                    ItemReviews.Add(entry);
                }
            }
            return ItemReviews;
        }
