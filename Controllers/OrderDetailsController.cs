...
namespace kwiqstage.Controllers
{
    ...
    public class OrderDetailsController : ControllerBase
    {
        ...
        public OrderDetailsController(kwiq_prodContext context)
        {
            _context = context;
        }
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<OrderDetails>> GetOrderDetailsId(int id)
        {
        ...
        // GET: api/orderdetails/order/order_number
        [HttpGet("order/{order_id}")]
        public ActionResult<List<OrderDetails>> GetOrderDetails(int order_id) 
        {
